...
if (!empty($_SESSION) AND (($_SESSION['userlevel'] == USER_ADMIN) OR ($_SESSION['userlevel'] == USER_MODERATOR) OR ($_SESSION['userlevel'] == USER_NORMAL))) {
	...
	<form method="post" action="index.php?rq=contact_action&type=signal_subject&subject_id='.$subjectID.'">
		<table border="0" cellpadding="0" cellspacing="5">
			<tr>
				...
				<td>
					<input name="subject" type="text" value="[Signal Sujet]: '.$subject_name.'" maxlength="100" size="25" readonly/>
				</td>
			</tr>
			<tr>
				<td align="right">
